...
// template<class T>
//  T MySin(T _in) noexcept
// {
//     return std::sin(_in);
// }

// template <class T>
//  T MyCos(T _in) noexcept
// {
//     return std::cos(_in);
// }

// template <class T>
//  T MyPow2(T _in) noexcept
// {
//     return std::pow(_in, 2);
// }

// template <class T>
//  T MySqrt(T _in) noexcept
// {
//     return std::sqrt(_in);
// }

// template <class T>
//  T MyAtan(T _in) noexcept
// {
//     return std::atan(_in);
// }

// using Comp = Complex<double, decltype(&MySin<double>), decltype(&MyCos<double>), decltype(&MyPow2<double>), decltype(&MySqrt<double>), decltype(&MyAtan<double>)>;

// struct ComplexTestCustom : public testing::Test
// {
//     Comp m_Number;
...
// TEST_F(ComplexTestCustom, Create)
// {
//     Comp tNumberEmpty{};
...
// TEST_F(ComplexTestCustom, CopyAssign)
// {
//     auto tNumber = Get();
...
// TEST_F(ComplexTestCustom, MoveAssign)
// {
//     auto tNumber_temp{Get()};
//     auto tNumber = std::move(tNumber_temp);
...
// TEST_F(ComplexTestCustom, Conjugate)
// {
//     auto tNumber = Get();
//     tNumber.conjugate();
...
// TEST_F(ComplexTestCustom, Addition)
// {
//     auto tNumber1 = Get();
//     auto tNumber2 = Get();
...
// TEST_F(ComplexTestCustom, Subtraction)
// {
...
// TEST_F(ComplexTestCustom, Mulitplication)
// {
//     auto tNumber1 = Get();
//     auto tNumber2 = Get();
...
// TEST_F(ComplexTestCustom, Division)
// {
//     auto tNumber1 = Get() + Get();
//     auto tNumber2 = Get();
...
// TEST_F(ComplexTestCustom, CompareEquals)
// {
...
// TEST_F(ComplexTestCustom, CompareNotEquals)
// {
